# -*- coding: utf-8 -*-
"""
Created on Sat Apr  2 08:15:22 2022
...
if __name__ == "__main__":
   ...
   # transient_time = 10000
    ...
    filenames = "spinup_fields12.dat"
    filename = "evol_fields12.dat"
    #T = time.process_time()
    ...
    ice = np.random.rand(1,model_parameters.ndim)*0.01
